...
public class OutputImpl extends EObjectImpl implements Output {
	 ...
	 * @ordered
	 */
	protected script.script.Output script;
	 ...
	 * @generated
	 */
	public script.script.Output getScript() {
		if (script != null && script.eIsProxy()) {
			InternalEObject oldScript = (InternalEObject)script;
			script = (script.script.Output)eResolveProxy(oldScript);
			if (script != oldScript) {
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public script.script.Output basicGetScript() {
		return script;
	}
	 ...
	 * @generated
	 */
	public void setScript(script.script.Output newScript) {
		script.script.Output oldScript = script;
		script = newScript;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AlgorithmPackage.OUTPUT__ALGORITHM:
				...
				return;
			case AlgorithmPackage.OUTPUT__SCRIPT:
				setScript((script.script.Output)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case AlgorithmPackage.OUTPUT__ALGORITHM:
				...
				return;
			case AlgorithmPackage.OUTPUT__SCRIPT:
				setScript((script.script.Output)null);
				return;
		}
