...
public interface tablePackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link table.table.impl.IdentColumnImpl <em>Ident Column</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see table.table.impl.IdentColumnImpl
	 * @see table.table.impl.tablePackageImpl#getIdentColumn()
	 * @generated
	 */
	int IDENT_COLUMN = 2;
	...
	/**
	 * Returns the meta object for the reference '{@link table.table.Table#getIdentColumn <em>Ident Column</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ident Column</em>'.
	 * @see table.table.Table#getIdentColumn()
	 * @see #getTable()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link table.table.Column#getUid <em>Uid</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Uid</em>'.
	 * @see table.table.Column#getUid()
	 * @see #getColumn()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute list '{@link table.table.Column#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Constraints</em>'.
	 * @see table.table.Column#getConstraints()
	 * @see #getColumn()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link table.table.Column#getReferences <em>References</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>References</em>'.
	 * @see table.table.Column#getReferences()
	 * @see #getColumn()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link table.table.Column#getDerivateFrom <em>Derivate From</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link table.table.IdentColumn <em>Ident Column</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Ident Column</em>'.
	 * @see table.table.IdentColumn
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link table.table.impl.IdentColumnImpl <em>Ident Column</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see table.table.impl.IdentColumnImpl
		 * @see table.table.impl.tablePackageImpl#getIdentColumn()
