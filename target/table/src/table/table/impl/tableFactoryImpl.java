...
public class tableFactoryImpl extends EFactoryImpl implements tableFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case tablePackage.TYPR:
				return createTyprFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case tablePackage.TYPR:
				return convertTyprToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Typr createTyprFromString(EDataType eDataType, String initialValue) {
		Typr result = Typr.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertTyprToString(EDataType eDataType, Object instanceValue) {
